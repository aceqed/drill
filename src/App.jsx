...
import { LineChart, Line, XAxis, YAxis, ResponsiveContainer, BarChart, Bar, ScatterChart, Scatter, Cell } from 'recharts';
...
const drillPath = {
  ...
  const getActualPathColors = () => {
    ...
    for (let i = 0; i < drillPath.actual.x.length; i++) {
      ...
      colors.push(lateralDeviation > thresholdCm ? '#EF4444' : '#EAB308'); // Red if beyond threshold, Yellow if within
    }
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="w-full max-w-full">
        ...
        <div className="bg-gray-800 border-b border-gray-700 py-4 px-8">
          <h1 className="text-4xl font-bold text-white text-center">DrillSense</h1>
        </div>

        {/* Main Dashboard - Full Width Grid */}
        <div className="p-8 grid grid-cols-12 gap-6 min-h-screen">
          ...
          <div className="col-span-3 bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
            <h3 className="text-xl font-semibold mb-6 text-center">Deviation from Planned Path</h3>
          ...
          <div className="col-span-3 bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors flex flex-col justify-center">
            <h3 className="text-xl font-semibold mb-6 text-center">Hole Depth</h3>
            <div className="text-center">
              <div className="text-8xl font-bold text-white mb-4 font-mono">2430</div>
          ...
          <div className="col-span-6 bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-6 h-80">
              <div className="col-span-2 bg-gray-900 rounded-lg border border-gray-600 relative overflow-hidden">
                <div ref={plot3dRef} className="absolute inset-0 w-full h-full"></div>
              </div>
              
              <div className="space-y-3 overflow-hidden">
                <div className="bg-gray-900 rounded-lg p-3 border border-gray-600">
                  <h4 className="text-gray-400 mb-2 text-sm">Lateral Deviation</h4>
                  <div className="text-2xl font-bold mb-2">12 cm</div>
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-blue-500 h-2 rounded-full w-1/3 shadow-lg"></div>
                  </div>
                  <div className="text-xs text-gray-400 mt-1">Target: &lt;15cm</div>
                </div>
                
                <div className="bg-gray-900 rounded-lg p-3 border border-gray-600">
                  <h4 className="text-gray-400 mb-2 text-sm">Angular Deviation</h4>
                  <div className="text-2xl font-bold mb-2">3.1°</div>
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-red-500 h-2 rounded-full w-1/4 shadow-lg"></div>
                  </div>
                  <div className="text-xs text-gray-400 mt-1">Target: &lt;2°</div>
                </div>
          ...
          <div className="col-span-6 grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
              ...
              <div className="text-4xl font-bold mb-2 font-mono">537.2m</div>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mr-3 mt-1"></div>
                    <div>
                      <div className="text-white font-medium">Hole deviation</div>
                      <div className="text-gray-400">125m depth</div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="text-white font-medium">High axial vibration</div>
                      <div className="text-gray-400">143m depth</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-yellow-500 rounded-full mr-3 mt-1"></div>
                    <div>
                      <div className="text-white font-medium">Partial collapse likely</div>
                      <div className="text-gray-400">289m depth</div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="text-white font-medium">Hole cansoin</div>
          ...
          <div className="col-span-12 bg-gray-800 rounded-lg p-6 border border-gray-700">
            <h3 className="text-xl font-semibold mb-6">Trajectory & Position Parameters</h3>
            <div className="grid grid-cols-4 gap-8">
              ...
              <div className="bg-gray-900 rounded-lg p-4 border border-gray-600">
                <div className="text-gray-400 mb-1">True vertical depth (TVD)</div>
